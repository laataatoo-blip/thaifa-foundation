...
<!-- Navigation - Fixed Top, 2-tier (Correct) -->
  ...
  <div class="bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-20">
        ...
        <!-- Mobile Menu Button -->
        <button class="lg:hidden p-2" type="button" aria-label="Open menu" onclick="toggleMobileMenu()">
      ...
      <div id="mobileMenu" class="lg:hidden hidden pb-4">
        <div class="flex flex-col gap-1 pt-2">
          <a href="index.php" class="px-4 py-3 rounded-md hover:bg-sky-100 hover:text-[#315d9f] transition-colors">หน้าแรก</a>
          <a href="about.php" class="px-4 py-3 rounded-md bg-sky-100 text-[#315d9f] transition-colors">เกี่ยวกับเรา</a>
          <a href="calendar.php" class="px-4 py-3 rounded-md hover:bg-sky-100 hover:text-[#315d9f] transition-colors">ปฏิทิน</a>
          <a href="shop.php" class="px-4 py-3 rounded-md hover:bg-sky-100 hover:text-[#315d9f] transition-colors">ร้านค้า</a>
          <a href="donate.php" class="px-4 py-3 rounded-md hover:bg-sky-100 hover:text-[#315d9f] transition-colors">การบริจาค</a>
          <a href="volunteer.php" class="px-4 py-3 rounded-md hover:bg-sky-100 hover:text-[#315d9f] transition-colors">จิตอาสา</a>
          <a href="stories.php" class="px-4 py-3 rounded-md hover:bg-sky-100 hover:text-[#315d9f] transition-colors">เสียงจากใจ</a>
          <a href="contact.php" class="px-4 py-3 rounded-md hover:bg-sky-100 hover:text-[#315d9f] transition-colors">ติดต่อเรา</a>
        </div>
      </div>
    </div>
  </div>
