...
<body>
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm">
        ...
        <div class="bg-white">
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div class="flex items-center justify-between h-20">
                                <a href="index.html" class="flex-shrink-0">
                                    <img src="img/Logo.png" alt="THAIFA Logo" class="h-16 w-auto" />
                                </a>
                                <div class="hidden lg:flex items-center gap-1">
                                    ...
                                    <a href="contact.php" class="text-[#315d9f] bg-sky-100 px-4 py-2 rounded-md">ติดต่อเรา</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid lg:grid-cols-2 gap-8 mb-12">
                    ...
                    <div class="p-8 md:p-10 bg-white border border-border rounded-3xl shadow-lg">
                        ...
                        <form onsubmit="handleSubmit(event)" class="space-y-6">
                            <div class="grid md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <input id="name" required placeholder="กรอกชื่อ-นามสกุล" class="w-full h-12 px-4 rounded-xl border border-border bg-white" />
                                </div>
                                <div class="space-y-2">
                                    <label for="email" class="text-sm">อีเมล *</label>
                                    <input id="email" type="email" required placeholder="example@email.com" class="w-full h-12 px-4 rounded-xl border border-border bg-white" />
                                </div>
                            </div>

                            <div class="space-y-2">
                                <label for="subject" class="text-sm">หัวข้อ *</label>
                                <input id="subject" required placeholder="เรื่องที่ต้องการติดต่อ" class="w-full h-12 px-4 rounded-xl border border-border bg-white" />
                            </div>

                            <div class="space-y-2">
                                <label for="message" class="text-sm">ข้อความ *</label>
                                <textarea id="message" required placeholder="เขียนข้อความของคุณที่นี่..." class="w-full min-h-40 p-4 rounded-xl border border-border bg-white"></textarea>
                            </div>
    ...
    <script>
        function handleSubmit(e) {
            ...
            alert(`ขอบคุณที่ติดต่อเรา คุณ${name}! เราจะตอบกลับภายใน 24 ชั่วโมง`);
            e.target.reset();
        }
