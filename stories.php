            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-20">
                    ...
                    <div class="hidden lg:flex items-center gap-1">
                        ...
                        <a href="stories.php" class="text-[#315d9f] bg-sky-100 px-4 py-2 rounded-md"><?= h(thaifa_t('stories')) ?></a>
    ...
    <main class="pt-[120px]">
        ...
        <section class="relative h-[400px] bg-gradient-to-br from-primary via-primary to-primary/90 flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
                <h1 class="text-5xl md:text-6xl mb-6"><?= h(thaifa_t('stories')) ?></h1>
                        ...
                        <div class="p-6 bg-white border border-border rounded-2xl hover:shadow-xl transition-all">
                            <div class="flex items-start gap-4 mb-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-foreground/60 text-sm"><?= $isEn ? 'Event Volunteer (1 year)' : 'จิตอาสาจัดกิจกรรม 1 ปี' ?></p>
