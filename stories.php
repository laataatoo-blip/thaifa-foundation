            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-20">
                    <a href="index.php" class="flex-shrink-0">
                        <img src="assets/images/Logo.png" alt="THAIFA Foundation logo featuring stylized checkmark with red circle and navy blue text, representing The Insurance and Financial Advisors Foundation" class="h-16 w-auto" />
                    </a>
    ...
    <div id="content-beneficiaries" class="space-y-8 hidden">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="p-6 bg-white border border-border rounded-2xl hover:shadow-xl transition-all">
                ...
                <div class="pt-4 border-t border-border">
                    <div class="flex items-start gap-2">
                        <svg class="w-4 h-4 text-accent flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 24 24">
