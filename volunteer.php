            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-20">
                    ...
                    <div class="hidden lg:flex items-center gap-1">
                        ...
                        <a href="volunteer.php" class="text-[#315d9f] bg-sky-100 px-4 py-2 rounded-md"><?= h(thaifa_t('volunteer')) ?></a>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 max-w-6xl mx-auto">
                    ...
                    <div class="p-8 bg-gradient-to-br from-card to-card/50 border-2 border-primary/10 rounded-3xl hover:shadow-2xl hover:border-accent/30 transition-all duration-300 group hover:-translate-y-1">
                        ...
                        <p class="text-foreground/70 leading-relaxed"><?= $isEn ? 'Join scholarship award activities and visit schools to meet students.' : 'ร่วมงานมอบทุนการศึกษาและลงพื้นที่โรงเรียนเพื่อพบปะน้องๆ' ?></p>
                    </div>
                </div>
                ...
                <div class="max-w-4xl mx-auto p-8 md:p-12 bg-card border border-border rounded-3xl shadow-xl">
                    <div class="text-center mb-8">
                        ...
                        <p class="text-foreground/70 text-lg leading-relaxed max-w-2xl mx-auto">
                            <?php if ($isEn): ?>
                                Please contact us via LINE first to discuss details and ask questions.<br />
                                Then we will send the volunteer application form to your email.
                            <?php else: ?>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-accent/5 rounded-2xl p-8 text-center">
                            ...
                            <h4 class="text-primary text-xl mb-2"><?= $isEn ? 'Submit Application by Email' : 'ส่งใบสมัครทางอีเมล' ?></h4>
                            <p class="text-foreground/70 mb-2"><?= $isEn ? 'After we discuss details, we will send the volunteer application form to your email.' : 'หลังจากคุยรายละเอียดแล้ว เราจะส่งใบสมัครจิตอาสาให้คุณทางอีเมล' ?></p>
                        ...
                        <div class="grid md:grid-cols-3 gap-4 mt-8">
                            ...
                            <div class="text-center p-4">
                                ...
                                <p class="text-foreground/60 text-sm"><?= $isEn ? 'To your registered email' : 'ทางอีเมลที่แจ้งไว้' ?></p>
                            </div>
                            <div class="text-center p-4">
