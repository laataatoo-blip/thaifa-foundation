        ...
        <div class="w-full max-w-2xl">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div class="text-center mb-8">
                    <h1 class="text-3xl text-primary mb-2">สมัครสมาชิก</h1>
                    <p class="text-foreground/60">ร่วมเป็นส่วนหนึ่งของ THAIFA Foundation</p>
                </div>
                ...
                <form id="registerForm" class="space-y-5">
                    ...
                    <div>
                        <label class="block text-sm text-foreground/80 mb-2">อีเมล <span class="text-accent">*</span></label>
                        <input 
                            type="email" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm text-foreground/80 mb-2">รหัสผ่าน <span class="text-accent">*</span></label>
                            <div class="relative">
                                <input 
                                    type="password" 
                                    id="password"
                                    ...
                                    required
                                >
                                <button type="button" onclick="togglePassword('password')" class="absolute right-4 top-1/2 -translate-y-1/2 text-foreground/40 hover:text-foreground/60">
                        ...
                        <div>
                            <label class="block text-sm text-foreground/80 mb-2">ยืนยันรหัสผ่าน <span class="text-accent">*</span></label>
                            <div class="relative">
                                <input 
                                    type="password" 
                                    id="confirmPassword"
                                    ...
                                    required
                                >
                                <button type="button" onclick="togglePassword('confirmPassword')" class="absolute right-4 top-1/2 -translate-y-1/2 text-foreground/40 hover:text-foreground/60">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                    </svg>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm text-foreground/80 mb-2">ชื่อ <span class="text-accent">*</span></label>
                            <input 
                                type="text" 
                                placeholder="ชื่อ"
                                class="w-full px-4 py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all"
                        ...
                        <div>
                            <label class="block text-sm text-foreground/80 mb-2">นามสกุล <span class="text-accent">*</span></label>
                            <input 
                                type="text" 
                                placeholder="นามสกุล"
                                class="w-full px-4 py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all"
                    ...
                    <!-- Phone & LINE (2 Columns) -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm text-foreground/80 mb-2">เบอร์โทรศัพท์ <span class="text-accent">*</span></label>
                            <input 
                                type="tel" 
                        ...
                        <div>
                            <label class="block text-sm text-foreground/80 mb-2">ไอดีไลน์</label>
                            <input 
                                type="text" 
                    ...
                    <div class="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                        <input 
                            ...
                            required
                        >
                        <label for="terms" class="text-sm text-foreground/70 leading-relaxed">
                            ฉันยอมรับ <a href="#" class="text-primary hover:underline">ข้อตกลงและเงื่อนไข</a> และ <a href="#" class="text-primary hover:underline">นโยบายความเป็นส่วนตัว</a> ของ THAIFA Foundation <span class="text-accent">*</span>
                        </label>
                    </div>
                    ...
                    <div class="text-center text-sm">
                        <span class="text-foreground/60">มีบัญชีอยู่แล้ว?</span>
                        <a href="login.html" class="text-primary hover:underline ml-1">เข้าสู่ระบบ</a>
                    </div>
                </form>
            </div>
        </div>
